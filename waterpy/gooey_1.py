...
os.chdir(r'C:\Users\mgerzan\Documents\MNG\2018-programming-waterpy\code\waterpy')
...
get_comparison_data
print ("Comparison stats recieved!")
...
write_output_csv
print ("Output timeseries written!")
...
write_output_matrices_csv
print ("Output matrices written!")
